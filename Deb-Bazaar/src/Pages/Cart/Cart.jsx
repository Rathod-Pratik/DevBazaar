...
const Cart = () => {
  ...
  return (
    <div className="mx-auto mt-12 w-[80%] min-h-[100vh] my-[30px] ">
      <div data-aos="fade-down" className="grid grid-cols-4 gap-4 text-gray-500 ">
        <p>Product</p>
        <p>Price</p>
        <p>Quantity</p>
        <p>Subtotal</p>
      ...
      <div className="my-6 flex justify-between">
        <button data-aos="fade-right" className="py-3 px-4 border-[1px] border-black hover:text-white hover:bg-red-500 transition-all duration-300 hover:border-none">
          Return to Shop
        </button>
        <button data-aos="fade-left" className="py-3 px-4  border-[1px]  border-black hover:text-white hover:bg-red-500 transition-all duration-300 hover:border-none">
          Update Cart
        </button>
      </div>
