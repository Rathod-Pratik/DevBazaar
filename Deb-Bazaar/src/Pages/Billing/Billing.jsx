...
const Billing = () => {
  ...
  return (
    <div className="min-h-[100vh] w-[98%] lg:w-[80%] mt-[40px] m-auto">
      <h1 data-aos="fade-down" className="text-[36px] font-medium my-6">
        Billing Details
      </h1>
        ...
        <div data-aos="fade-left" className="flex flex-col gap-3 mt-6">
          ...
          <div className="w-[90%] m-auto h-full flex flex-col gap-5 mt-8 ">
            ...
            <button
              ...
              className="py-3 px-4 mb-3 text-white bg-red-500 hover:bg-red-600 transition-all duration-300 rounded-[5px] h-[45px] w-[200px]"
            >
              Place Order
            </button>
          </div>
