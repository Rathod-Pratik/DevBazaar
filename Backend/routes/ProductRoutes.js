...
import { Get_Product, Delete_Product, Update_Product } from "../controller/Products.js";
...
router.post("/createproduct",upload.single('product_image'),UploadToCloudinary, Get_Product);
